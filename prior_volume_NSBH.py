...
priors_physics_based = BNSPriorDict_chirpmass_lambda_tilde(MCL_filename='/Users/smag0001/McLambda_prior/MCL_NSBH_new.dat')
...
# Need to set this as the NSBH prior goes up to 3 solar masses 
priors_uniform['chirp_mass_source'] = Uniform(name='chirp_mass_source',minimum=0.8,maximum=3.0)
# # The priors that are not Mchirp/lambda_tilde are set to be the same as the physics based priors
